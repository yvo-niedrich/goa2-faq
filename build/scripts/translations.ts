...
export function applicationTranslations(): TranslationMap {
    return {
        ...
        'app.header.dashboard.hint': 'Pick a hero first',
        'app.header.settings': 'Settings',
        'app.button.search': 'Search...',
        'app.button.select': 'Select',
        'app.button.close': 'Close',
        'app.button.back': 'All heroes',
        'app.faq.title': 'Rules & clarifications',
        'app.faq.hint': 'Rules clarifications available',
        ...
        'app.card.previous': 'Previous card',
        'app.card.next': 'Next card',
